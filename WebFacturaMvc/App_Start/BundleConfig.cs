...
namespace WebFacturaMvc
{
    ...
    {
        public static void RegistroBundles(BundleCollection bundles){
            
            bundles.Add(new StyleBundle("~/Public/principal").Include("~/Public/css/principal.css"));
            bundles.Add(new StyleBundle("~/Public/materialize").Include("~/Public/css/materialize.css"));


            bundles.Add(new ScriptBundle("~/Public/js").Include("~/Public/js/materialize.min.js"));
            bundles.Add(new ScriptBundle("~/Public/jquery").Include("~/Public/plugins/jquery.min.js"));
