...
namespace Model.Dao
{
    public class VentaDao
    {
        ...
        {
            string idVenta = "";
            string create = "insert into venta(total,idCliente,idUsuario,fecha,IVA) values('" + objVenta.Total + "','" + objVenta.IdCliente + "','" + objVenta.IdVendedor + "','" + objVenta.Fecha + "','"+objVenta.Iva+ "') SELECT SCOPE_IDENTITY();";
            try
            {
